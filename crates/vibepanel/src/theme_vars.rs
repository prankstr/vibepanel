...
pub(super) const THEME_VAR_EXPECTATIONS: &[ThemeVarExpectation] = &[
    ...
    var("--bar-padding-bottom", UserHook, OptionalBuiltinCss),
    var("--bar-padding-left", UserHook, OptionalBuiltinCss),
    var("--bar-padding-right", UserHook, OptionalBuiltinCss),
    var("--bar-padding-top", UserHook, OptionalBuiltinCss),
    var("--bar-padding-x", UserHook, OptionalBuiltinCss),
    var("--bar-padding-y", UserHook, OptionalBuiltinCss),
    ...
    var("--widget-content-gap-offset", UserHook, OptionalBuiltinCss),
    var(
        "--widget-content-padding-offset",
        UserHook,
        OptionalBuiltinCss,
    ),
    var("--widget-padding-y", Root, BuiltinCss),
    var("--vp-widget-content-gap-h", Root, BuiltinCss),
    var("--vp-widget-content-gap-v", Root, BuiltinCss),
    var("--vp-widget-content-padding-h", Root, BuiltinCss),
    var("--vp-widget-content-padding-v", Root, BuiltinCss),
];
